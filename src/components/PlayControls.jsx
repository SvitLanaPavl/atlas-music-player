...
const PlayControls = () => {
  return (
    <div className='mb-5 flex items-center justify-between'>
      ...
      <button className='inline-flex h-10 w-10 items-center justify-center whitespace-nowrap rounded-md text-sm leading-5 font-medium transition duration-150 ease-in-out outline-customPurple-500 outline-solid'>
